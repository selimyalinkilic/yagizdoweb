      ...
      <Navbar bg="white" expand="lg">
        ...
        <div className={showClass ? "navbar-collapse collapse show" : "navbar-collapse collapse"}>
          <Nav className="ml-auto" activeKey="home">
            ...
            <a href="/dokumaciCV.pdf" className="nav-link d-block d-lg-none d-xl-none">Özgeçmiş</a>
          </Nav>
          <div className="menuOther">
            <a href="/dokumaciCV.pdf" className="resumeLink d-none d-lg-block d-xl-block">Özgeçmiş</a>
